...
from pipeline.vpc.detectors import PhrasalVerbDetector
from pipeline.vpc.resources.vpc_reference import (
    FrozenVpcFramePolicyProvider,
    FrozenVpcReferenceProvider,
)
from pipeline.vpc.resources.wordnet_nltk import NltkWordNetVpcProvider
