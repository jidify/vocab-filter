...
from poc_pipeline.vpc import VENDORED_SOURCE_VERSION as BOOKLEX_VERSION
from poc_pipeline.vpc.domain.phrasal_verbs import (
    PhrasalVerbCategory,
    PhrasalVerbDecision,
...
from poc_pipeline.vpc.domain.ports import VpcLexiconProvider, VpcReferenceProvider
from poc_pipeline.vpc.domain.resources import ResourceMetadata
from poc_pipeline.vpc.domain.vpc_frames import (
